...
class SparseStarCraft2Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        self.nf_al, self.nf_en = self.get_nf_size()

    def get_nf_size(self):
        """Returns the size of ally state and enemy state.
        """
