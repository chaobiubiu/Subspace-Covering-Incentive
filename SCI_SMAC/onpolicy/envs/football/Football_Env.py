...
class FootballEnv(object):
    ...
    def __init__(self, args):
        ...
        elif self.scenario_name == "academy_counterattack_hard":
    ...
    def step(self, action):
        ...
        return obs, obs, reward, done, info, self.get_avail_actions()

    def get_avail_actions(self):
        """Returns the available actions of all agents in a list."""
        return [[1 for _ in range(self.env.action_space[0].n)] for agent_id in range(self.num_agents)]
