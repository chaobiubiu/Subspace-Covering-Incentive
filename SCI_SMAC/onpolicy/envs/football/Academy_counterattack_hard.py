...
class Academy_Counterattack_Hard(object):

    def __init__(self, args):
        assert args.num_agents == 4, "Academy_Counterattack_Hard must follow the 4-agents setting."
    ...
    def get_simple_obs(self, index=-1):
        ...
        if index == -1:
            ...
            simple_obs.append(full_obs['left_team'][-self.n_agents:].reshape(-1))       # 2x4
            simple_obs.append(full_obs['left_team_direction'][-self.n_agents:].reshape(-1))     # 2x4

            simple_obs.append(full_obs['right_team'][0])        # 2
            simple_obs.append(full_obs['right_team'][1])        # 2
            simple_obs.append(full_obs['right_team'][2])        # 2
            simple_obs.append(full_obs['right_team_direction'][0])      # 2
            simple_obs.append(full_obs['right_team_direction'][1])      # 2
            simple_obs.append(full_obs['right_team_direction'][2])      # 2
