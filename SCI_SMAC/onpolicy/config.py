...
def get_config():
    parser = argparse.ArgumentParser(description='onpolicy')

    # prepare parameters
    parser.add_argument("--algorithm_name", type=str, default='rmappo', choices=["rmappo", "mappo", "happo", "hatrpo", "mat", "mat_dec"])
    ...
    parser.add_argument("--num_env_steps", type=int, default=5e6,
    ...
    # env parameters
    parser.add_argument("--env_name", type=str, default='Football', choices=["Grid", "MPE", "StarCraft2", "SparseStarCraft2", "StarCraft2v2", "Football"], help="specify the name of environment")
    ...
    # SCI parameters
    parser.add_argument("--num_objects", type=int, default=3, help="the number of classes of objects")
    parser.add_argument("--state_novel_coef", type=float, default=1.0, help="the coef of state novelties")
    parser.add_argument("--use_weight_one", action='store_true', help="Default False, use mutual-information based weights")
    parser.add_argument("--ir_coef", type=float, default=0.01, help="the coef of weighted sub-state novelties")

    # RND params
    parser.add_argument("--rnd_lr", type=float, default=5e-3, help='learning rate of RND networks')
    parser.add_argument("--rnd_rep_size", type=int, default=32, help="Latent dimension of RND")

    # HDD params
    parser.add_argument("--hdd_lr", type=float, default=5e-3, help="learning rate of HDD network")
    parser.add_argument("--hdd_epoch", type=int, default=5, help="number of epoches for updating HDD networks")
    parser.add_argument("--use_hdd_active_masks", action='store_false', default=True,
                        help="by default True, whether to mask useless data in HDD.")
    ...
    # save parameters
    parser.add_argument("--save_interval", type=int, default=200, help="time duration between contiunous twice models saving.")
