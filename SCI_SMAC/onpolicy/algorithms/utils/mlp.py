...
class MLPLayer(nn.Module):
    def __init__(self, input_dim, hidden_size, layer_N, use_orthogonal, use_ReLU, use_LayerNorm=True):
        ...
        if use_LayerNorm:
            ...
            self.fc2 = nn.ModuleList([nn.Sequential(init_(nn.Linear(hidden_size, hidden_size)), active_func) for i in range(self._layer_N)])
