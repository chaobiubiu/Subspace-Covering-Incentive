...
CUDA_VISIBLE_DEVICES=4 python ../src/train.py --env_name ${env} --map_ind ${ind} --n_agents ${nagt} \
...
--save_hdd_count --run_dir exp_logs --experiment_name SCI_ablation --use_state_count --use_state_mutual --n_rollout_threads 128 \